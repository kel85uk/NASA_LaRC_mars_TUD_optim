%% Objective function for both optimization methods
% kklloh

function [U] = transfer_ellipse_optim_obj(X_vec,mu,mu_1,mu_2,stay_return,dt_stay,Isp)
...
[OTV_finalmass,m_tank,m_payload,m_prop,m_shield,acc_max,acc_min,output_add] = OTVsizing(DV1,DV2,dt1,dt_stay,dt2,4,Isp);

U = OTV_finalmass;% + T_p1 + T_p2;
%U = (1 - exp(-DeltaV)) + dt1 + dt2 + T_p1 + T_p2 + ecc_p1 + ecc_p2;
end
