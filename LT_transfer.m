function[k2_final,N_final,gamma1_final,TOF_final,dV_trans,m_expo]=LT_transfer(r1,r2,mu,TOF_req,timestep,payload,T,Isp)
%
% This function will optimize a transfer from one orbit to another, using
% the exposin2 code.
%
%
...
N_vec = 100:10:250;                    % [revs]
k2_vec = 0.0005:0.0001:0.001;                % [-]
gamma1 = deg2rad(0:0.01:0.1);  % [rad]
%--------------------------------------------------------------------------
...
a_matr = zeros(length(k2_vec),length(N_vec),length(gamma1));
counter = 0;
